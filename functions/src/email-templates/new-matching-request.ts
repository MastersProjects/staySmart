/**
 * E-Mail Template for Cloud Function notifyTutorOnNewMatchingRequest
 * Notify Tutor by E-Mail on new matching TutorSearchRequest
 */
export const newMatchingRequestTemplate = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
\t\t\t#menux6mi8v~div label {
\t\t\t\tborder-radius: 0% !important;
\t\t\t}

\t\t\t#menux6mi8v:checked~.menu-links {
\t\t\t\tbackground-color: #000000 !important;
\t\t\t}

\t\t\t#menux6mi8v:checked~.menu-links a {
\t\t\t\tcolor: #ffffff !important;
\t\t\t}

\t\t\t#menux6mi8v:checked~.menu-links span {
\t\t\t\tcolor: #ffffff !important;
\t\t\t}
\t\t}
\t</style>
...
<p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><strong><span style="font-size: 18px;">Neue Nachhilfeanfrage!</span></strong></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<p style="line-height: 1.2; word-break: break-word; font-size: 14px; mso-line-height-alt: 17px; margin: 0;"><span style="font-size: 14px;">Es gibt eine neue Nachhilfeanfrage, die für dich passen könnte.  </span><span style="font-size: 14px;">Reagiere so schnell wie möglich mit einer Offerte!</span></p>
<p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;"> </p>
<p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;"> </p>
...
<p style="line-height: 1.2; word-break: break-word; font-size: 14px; mso-line-height-alt: 17px; margin: 0;"><span style="font-size: 14px;">Dein  stay smart Team</span></p>
