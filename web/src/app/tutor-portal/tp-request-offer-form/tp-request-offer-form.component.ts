...
@Component({
  selector: 'app-tp-request-offer',
  templateUrl: './tp-request-offer-form.component.html',
  styleUrls: ['./tp-request-offer-form.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TpRequestOfferFormComponent implements OnInit {
